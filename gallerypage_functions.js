...
function setParagraphs(btn) {
  ...
  if (btn == "dot3") {
    ...
    document.getElementById("designP").innerHTML =
      'This Facebook banner was designed for ISU Welcome Week 2023. Designed to capture the essence of campus life, it serves as a visual gateway to a week filled with excitement, collaboration, and the spirit of ISU, setting the tone for a great start to a new school year! <ul class="page_link"><li id="design_link"><a href="sit_work.html" target="_blank">See more work for the School of IT</a></li></ul>';
  }
  if (btn == "dot4") {
...
function setImages(btn) {
  ...
  if (btn == "dot1") {
    ...
    link.innerHTML =
      '<a id="bonfire_link" href="https://xd.adobe.com/view/cbbada60-2f54-4054-ab31-a2f2438b3603-9ee9/" target="_blank">Open in browser</a>';
  ...
  if (btn == "dot3") {
    ...
    link.innerHTML =
      '<a href="sit_work.html" target="_blank">See more work for the School of IT</a>';
  }
  if (btn == "dot4") {
